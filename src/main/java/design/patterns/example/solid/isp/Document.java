...
// The problem We're not following the Interface Segregation Principle. It means we don't need the extra methods from Machine Interface on OldFashionedPrinter class.
